...
const getMethodIcon = (id: string) => {
  switch (id) {
    ...
    case "binance":
      return (
        // Logo oficial de Binance en dorado (sobre el tile negro).
        <svg viewBox="0 0 32 32" width={26} height={26} fill="#F3BA2F" style={{ display: "block" }}>
    ...
    case "daviplata":
      return (
        <svg viewBox="5.88 9.87 291 157.1" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style={{ width: 30, height: 16 }}>
          ...
          <path d="m124.36 151.99c0 3.77.02 7.54-.01 11.31-.01 2.17-.83 3.19-2.42 3.14-1.55-.05-2.42-1.16-2.42-3.23-.01-7.61-.01-15.22 0-22.83 0-2.09.86-3.23 2.38-3.27 1.57-.05 2.46 1.12 2.47 3.36.02 3.84 0 7.68 0 11.52zm54.76-100.86c1.91.17 3.82.3 5.73.53.46.06 1.15.07 1.22.79.07.64-.25 1.15-.74 1.54-1 .81-2.26.89-3.41.83-3.77-.18-7.54-.45-11.17-1.62-3.77-1.21-4.96-3.1-4.14-6.91 1.07-4.99 4.15-8.95 7.05-12.97.5-.7 1.17-.46 1.78-.12.74.41.67.98.37 1.69-1.09 2.65-2.9 4.89-4.26 7.38-.73 1.33-1.55 2.62-1.96 4.1-.6 2.19.09 3.6 2.24 4.32 2.37.79 4.84.57 7.29.44z" fill="#fff"/>
          <path d="m139.38 155.61c0 2.52-.02 5.04.01 7.56.01 1.62-.72 2.51-2.36 2.53-1.67.03-2.65-.72-2.65-2.48 0-5.11.02-10.21-.01-15.32-.01-1.73.85-2.69 2.48-2.69 1.61 0 2.57.89 2.55 2.64-.04 2.58-.02 5.17-.02 7.76z" fill="#fff"/>
